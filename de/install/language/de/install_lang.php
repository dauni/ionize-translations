...
$lang['database_success_install'] = 		'<strong class="ex">Die Datenbank wurde erfolgreich angelegt.</strong>';
$lang['database_success_install_no_settings_needed'] = 		'<strong class="ex">Datenbank OK.</strong><br/>Da die Datenbank bereits besteht, wird der Schritt zu den Website-Einstellungen übersprungen.';
$lang['database_success_migrate'] = 		'<strong class="ex">Die Datenbank wurde erfolgreich aktualisiert.</strong>';
...
$lang['database_error_writing_config_file'] = 		"<strong>Fehler :</strong><br/>Die Datei <strong style=\"color:#000;\">/application/config/database.php</strong> konnte nicht geschrieben werden!<br/> Prüfen Sie die Schreibrechte.";
